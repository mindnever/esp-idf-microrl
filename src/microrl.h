...
struct microrl_s {
    ...
    int (*execute)(int argc, const char *const *argv, microrl_t *pThis); // ptr to 'execute' callback
    char * *(*get_completion)(int argc, const char *const *argv, microrl_t *pThis); // ptr to 'completion' callback
    void (*print)(const char *, microrl_t *pThis); // ptr to 'print' callback
#ifdef _USE_CTLR_C
